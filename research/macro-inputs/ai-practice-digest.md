...
2. **Problem discovery & advisory** — problem-first framing vs solution-led proposals ("jobs-to-be-done", used loosely = the operational task AI should do); define success before choosing a tool. The Ian coaching arc + Stage-Gate/Information Paper process are the dogfooded proof. *(Dogfooded-now.)*
